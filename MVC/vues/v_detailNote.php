...
<body>
    <form>
        <h2><?php echo $_SESSION['idValeur']. 'Fldzzd'?></h2>
...
<?php
		foreach($lesForfaits as $unForfait)
        {
        $id = $unForfait['idforfait'];
        $libelle = $unForfait['libelleforfait'];
        $montant = $unForfait['montant'];
